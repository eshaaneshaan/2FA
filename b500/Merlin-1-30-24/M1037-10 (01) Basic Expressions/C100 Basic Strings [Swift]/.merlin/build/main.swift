...
print ("five","four","three","two","one","zero", separator: "|")
...
print ("line one","line two","line three", separator: "\n")
...
print ( "fourteen", "fifteen", x, "sixteen", y, "seventeen", separator: "\n")
// 13. Print the following strings separated by the string "-<|>-":
//     "five", "five", "five", "one", "two"
print ("five", "five", "five", "one", "two", separator: "-<|>-")
